				...
				<div className="e_card">
					<h1 className="text-gray-400">
						...
						<div className="scroller">
							<span>
								<span className="word logi"> {t('logistics')}</span>
								<br />
								<span className="word tech"> {t('technology')}</span>
								<br />
								<span className="word mark"> {t('grow')}</span>
							</span>
						</div>
						<div className="note" />
						<div>
							<p className="grow-text">{t('growProductsServices')}</p>
						</div>
					</h1>
				</div>
