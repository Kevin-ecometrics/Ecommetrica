...
function Ubication() {
	...
	return (
		<div className="p-4 text-center text-black md:p-24 min-h-min">
			<h1 className="text-3xl font-bold text-[#623375]">{t('ubication.findUs')}</h1>
			<p className="text-[#F52F55] text-4xl">{t('ubication.anyQuestions')}</p>
			<p className="text-[#F52F55] text-4xl">{t('ubication.weLoveToAnswer')}</p>
				...
				<div className="flex items-center flex-1 p-8 text-black md:p-8">
					<List spacing={3}>
						...
						<div className="flex">
							...
							<ListItem>Calle Ignacio Zaragoza 8169-306, 22000 Tijuana, B.C. </ListItem>
						</div>
						<div className="flex">
